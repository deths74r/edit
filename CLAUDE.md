...
`edit` is a minimal terminal text editor written in C (v0.15.0). It features full UTF-8/Unicode 17.0 support, real-time C syntax highlighting, grapheme cluster navigation, paired delimiter matching, soft line wrapping, and auto-indent with comment toggling.
...
Single-file architecture: `src/edit.c` (~7200 lines) organized into sections with banner comments (`/*** Title ***/`).
