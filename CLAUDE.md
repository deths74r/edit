...
**See [SIFT.md](SIFT.md) for complete sift documentation.**

You MUST use sift tools instead of native tools:
- `sift_search` instead of Grep/Glob
- `sift_read` instead of Read
- `sift_update` instead of Edit (same API)
- `sift_write` instead of Write

Run `sift_docs` for full reference.
