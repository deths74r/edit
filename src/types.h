...
#define SCROLL_VELOCITY_TIMEOUT                                                \
  0.4 /* Seconds of inactivity before velocity resets */
...
#define INITIAL_OPERATION_CAPACITY                                             \
  16 /* Initial capacity for ops within a group */
...
/* Kitty keyboard protocol - enables enhanced key detection */
#define ESCAPE_KITTY_KEYBOARD_ENABLE "\x1b[>1u"
...
struct editor_state {
  ...
  /* First visible segment within row_offset line (for wrap mode scrolling). */
  ...
  /* Theme preview state. */
  bool theme_preview_active;  /* True while cycling through themes */
  int theme_preview_original; /* Theme index before preview started */
